...
namespace QuantInfra.Sdk.Trading.Positions
{
    public class Position
    {
        ...
        public decimal OpenPrice => Volume != 0 ? TotalOpenPayments / Volume : 0;
        ...
        public decimal SettlPrice => Volume != 0 ? TotalSettlPayments / Volume : 0;
        ...
        )
        {
            ...
            return (
                ...
                {
                    OpenTradeId = tradeId,
                    TotalOpenPayments = TotalOpenPayments + calculatedCcyLastQty,
                    TotalSettlPayments = TotalSettlPayments + calculatedCcyLastQty,
        ...
        )
        {
            ...
            var realizedPnL = (newTotalPayment - TotalOpenPayments) * Side.GetSign() - calculatedCcyLastQty * Side.Invert().GetSign();
        ...
        )
        {
            ...
            {
                return IncreasePosition(tradeId, Math.Abs(signedVolume), calculatedCcyLastQty, fxRate, accountCcyPrecision, dt, commission, parentPositionId);
            }
            ...
            if (absVolume <= Volume)
            {
                return ReducePosition(tradeId, absVolume, price, calculatedCcyLastQty, fxRate, accountCcyPrecision, dt, commission, settlCcyPrecision, parentPositionId);
            }
            ...
            var (_, historyRecord) = ReducePosition(tradeId, Volume, price, closingPayment, fxRate,
                accountCcyPrecision, dt, closingCommission, settlCcyPrecision, parentPositionId);
            var actualPosition = OpenPosition(tradeId, ContractId, AccountId, reopenVolume, signedVolume.FromSign(), 
                paymentBroughtForward, fxRate, accountCcyPrecision, dt, IsSynthetic, parentPositionId,
        ...
        {
            var floatingPnL = signedValue - TotalSettlPayments * Side.GetSign();
        ...
        )
        {
            ...
            if (targetSignedVolume != 0)
            {
                ...
                res.Add(new Trade(
                    ...
                    $"Offset {dt}-O", 
                    accountId, contractId, null, null, StrategyPositionId, null, 
                    PositionEffect.Open, targetSignedVolume.FromSign(), Math.Abs(targetSignedVolume), calculator.GetPrice(targetSignedVolume, targetPayments), 
                    0, dt, null, null,
                    new Dictionary<int, decimal>(),
                    paymentCurrencyId, fxRate,
                    targetPayments, 
