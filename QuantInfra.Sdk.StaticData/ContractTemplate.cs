...
public class ContractTemplate
{
	...
	public ContractTemplate(int templateId, string name, SecurityType securityType, Asset? asset, decimal minSize,
		...
		decimal? tickValue, decimal priceQuotation, Currency settlementCurrency, PLCalculatorType plCalculatorType,
	...
	public PLCalculatorType PlCalculatorType { get; init; } = PLCalculatorType.Default;
