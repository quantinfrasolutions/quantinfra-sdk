...
public class ExchangeBar
{
    ...
    {
        return $"{{ ExchangeBar | StreamId: {StreamId}, ContractId: {ContractId}, OpenDt: {OpenDt}, CloseDt: {CloseDt}, Open: {Open}, High: {High}, Low: {Low}, Close: {Close}, Volume: {Volume}, DollarValue: {DollarValue}, TradingSessionId: {TradingSessionId} }}";
    }

    protected bool Equals(ExchangeBar other)
    {
        return StreamId == other.StreamId && ContractId == other.ContractId && OpenDt.Equals(other.OpenDt) && CloseDt.Equals(other.CloseDt) && Open.Equals(other.Open) && High.Equals(other.High) && Low.Equals(other.Low) && Close.Equals(other.Close) && Volume.Equals(other.Volume) && DollarValue.Equals(other.DollarValue) && TradingSessionId == other.TradingSessionId;
    }
