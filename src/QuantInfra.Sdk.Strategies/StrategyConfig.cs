...
public class StrategyConfig : AlgorithmParams
{
    ...
    public StrategyConfig(string name, string className, string? @params,
    ...
    public StrategyConfig(StrategyConfig s) : this(s.Name, s.ClassName, s.Params,
    ...
    public override string ToString() =>
        $"<StrategyConfig {{ Name={Name}, StrategyClassName={ClassName}, " +
        $"Params={Params}, " +
